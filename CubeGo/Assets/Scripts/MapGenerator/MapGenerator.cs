...
public class MapGenerator : MonoBehaviour
{
    ...
    private Vector3 wallDelta = Vector3.forward * 5 + Vector3.up * 4;
    ...
    private void Start()
    {
        ...
        platforms.Add(Vector3.forward * 5 + Vector3.up * 4, Instantiate(platformPrefab, Vector3.forward * 5 + Vector3.up * 4, Quaternion.Euler(Vector3.right * 90f)));
    }
